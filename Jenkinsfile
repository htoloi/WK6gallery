pipeline {
    agent any
        ...
        always{
            ...
            slackSend channel: "sarah_ip1", message: "Build Started: ${env.JOB_NAME} ${env.BUILD_NUMBER} (<${env.BUILD_URL}|Open>)" script {env.FILENAME = readFile 'https://week6galleryip.onrender.com/'}

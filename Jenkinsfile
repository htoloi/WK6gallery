pipeline {
    agent any
        ...
        always{
            ...
            slackSend channel: "sarah_ip1", message: "Build Started: ${env.JOB_NAME} ${env.BUILD_NUMBER} (<${env.BUILD_URL}|Open> "println:"https://week6galleryip.onrender.com/${downloadFile})"
